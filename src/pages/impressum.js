  ...
  return (
    <Layout>
      ...
      <div style={{ lineHeight: "1.5", textAlign: "center" }}>
        ...
        <h3 style={{ marginTop: "50px" }}>Disclaimer – rechtliche Hinweise</h3>
        <div
          style={{
            textAlign: "justify",
        ...
        >
          ...
          <p>
            ...
            1 TMG für eigene Inhalte und bereitgestellte Informationen auf
            diesen Seiten nach den allgemeinen Gesetzen verantwortlich; nach den
            §§ 8 bis 10 TMG jedoch nicht verpflichtet, die übermittelten oder
            gespeicherten fremden Informationen zu überwachen. Eine Entfernung
            oder Sperrung dieser Inhalte erfolgt umgehend ab dem Zeitpunkt der
            Kenntnis einer konkreten Rechtsverletzung. Eine Haftung ist erst ab
            dem Zeitpunkt der Kenntniserlangung möglich.
          </p>
          <p>
          ...
          <p>
            ...
            gewährleistet werden kann. Der Anbieter übernimmt keine Haftung für
            die durch solche Sicherheitslücken entstandenen Schäden.{" "}
          </p>
          <p>
            ...
            <a href="http://www.mustervorlage.net/disclaimer-muster/">
              Muster Disclaimer
            </a>
          </p>
        </div>
